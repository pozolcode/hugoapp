            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('backpack.auth.login') }}">
                        ...
                        <div class="form-group row">
                            <div class="col-md-12 reset-password">
                                @if (backpack_users_have_email() && config('backpack.base.setup_password_recovery_routes', true))
                                    <a class="btn btn-link" href="{{ route('backpack.auth.password.reset') }}">¿Olvidaste tu contraseña?</a>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="form-group row alternative-login">
                            <div class="col-md-12">
                                <div class="alternative-login-message">
                                    Puedes ingresar usando tus redes sociales
                                </div>

                                <div class="alternative-login-buttons">
                        ...
                        @if (config('backpack.base.registration_open'))
                            <div class="form-group row registration-row">
                                <div class="registration-message">¿Todavía no tienes cuenta? <a href="{{ route('backpack.auth.register') }}">Regístrate</a></div>
                            </div>
                        @endif
                    </form>
                </div>
